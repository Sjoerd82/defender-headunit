...
# DBus service for handling MPD updates

# This script listens to com.arctura.headunit
# This script emits signals on com.arctura.mpdupdate
...
class updControl(dbus.service.Object):
	...
	def __init__(self, bus_name):
		...
		print('[DBUSUPD] Initializing MPD Update Daemon')
...
try:
    bus_name = dbus.service.BusName("com.arctura.mpdupdate",
                                    bus=dbus.SystemBus(),
                                    do_not_queue=True)
