...
def test_a(cmd, params):
	print("WHOPPA! AAAAA!")

def test_b(cmd, params):
	print("WHOPPA! BBBBB!")
...
thingy7 = {
	  'track': { 'GET' : globals()['sc_player_track'], 'SET' : globals()['test_next_track'] }
	, 'folders': { 'GET' : globals()['sc_player_folders'], 'SET' : globals()['sc_player_folders'] }
	, 'pause': { 'GET' : globals()['sc_player_pause'], 'SET' : globals()['sc_player_pause'] }
	, 'state': { 'GET' : globals()['sc_player_state'], 'SET' : globals()['sc_player_state'] }
	, 'random': { 'GET' : globals()['sc_player_random'], 'SET' : globals()['sc_player_random'] }
	, 'randommode': { 'GET' : globals()['sc_player_randommode'], 'SET' : globals()['sc_player_randommode'] }
	, 'next': { 'GET' : globals()['sc_player_next'], 'SET' : globals()['sc_player_next'] }
	, 'prev': { 'GET' : globals()['sc_player_prev'], 'SET' : globals()['sc_player_prev'] }
	, 'seekfwd': { 'GET' : globals()['sc_player_seekfwd'], 'SET' : globals()['sc_player_seekfwd'] }
	, 'seekrev': { 'GET' : globals()['sc_player_seekrev'], 'SET' : globals()['sc_player_seekrev'] }
	, 'playlist': { 'GET' : globals()['sc_player_playlist'], 'SET' : globals()['sc_player_playlist'] }
	, 'update': { 'GET' : globals()['sc_player_update'], 'SET' : globals()['sc_player_update'] }
}

zmq_player = {
	  'track': globals()['sc_player_track']
	, 'folders': globals()['sc_player_folders']
	, 'test': {
		  'a':globals()['test_a']
		, 'b':globals()['test_b']
	}
...
def sc_player_track(cmd, params):
	return True

def sc_player_folders(cmd, params):
	return True

def sc_player_pause(cmd, params):
	return True

def sc_player_state(cmd, params):
	return True

def sc_player_random(cmd, params):
	return True

def sc_player_randommode(cmd, params):
	return True

def sc_player_next(cmd, params):
	return True

def sc_player_prev(cmd, params):
	return True

def sc_player_seekfwd(cmd, params):
	return True

def sc_player_seekrev(cmd, params):
	return True

def sc_player_playlist(cmd, params):
	return True

def sc_player_update(cmd, params):
	return True
...
def mq_recv():
	...
	zmq_player[path[0]][path[1]](cmd,params)
